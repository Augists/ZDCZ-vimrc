...
local get_colors = function()
    if Augists.settings.colorscheme == 'onedark' then
        local colors = {
            lightbg = '#38393f',
            black = "#2a2e36",
            red = "#e06c75",
        ...
        return colors
    elseif Augists.settings.colorscheme == 'tokyonight' then
        local colors = {
            lightbg = "#414868",
            black = "#24283b",
            red = "#f7768e",
        ...
        return colors
    elseif Augists.settings.colorscheme == 'nord' then
        local colors = {
            lightbg = '#4C566A',
            black = "#3B4252",
            red = "#BF616A",
        ...
        return colors
    elseif Augists.settings.colorscheme == 'custom' then
        local colors = {
            lightbg = "#414868",
            black = "#24283b",
            red = "#f7768e",
        ...
        return colors
    elseif Augists.settings.colorscheme == 'gruvbox' then
        local colors = {
            lightbg = "#504945",
            black = '#272727',
            red = "#cc231c",
        ...
        return colors
    elseif Augists.settings.colorscheme == 'dracula' then
        local colors = {
            lightbg = "#44475a",
            black = '#282a36',
            red = "#ff5555",
