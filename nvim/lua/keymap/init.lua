...
local plug_map = {
    -- modified keymap
    -- ["i|<C-n>"]      = map_cmd('v:lua.tab_complete()'):with_expr():with_silent(),
    -- ["i|<C-p>"]    = map_cmd('v:lua.s_tab_complete()'):with_silent():with_expr(),
...
--     ["n|K"]              = map_cr("Lspsaga hover_doc"):with_noremap():with_silent(),
    ...
    ["n|<Leader>1"]      = map_cr("BufferLineGoToBuffer 1"):with_silent(),
    ["n|<Leader>2"]      = map_cr("BufferLineGoToBuffer 2"):with_silent(),
    ["n|<Leader>3"]      = map_cr("BufferLineGoToBuffer 3"):with_silent(),
    ["n|<Leader>4"]      = map_cr("BufferLineGoToBuffer 4"):with_silent(),
    ["n|<Leader>5"]      = map_cr("BufferLineGoToBuffer 5"):with_silent(),
    ["n|<Leader>6"]      = map_cr("BufferLineGoToBuffer 6"):with_silent(),
    ["n|<Leader>7"]      = map_cr("BufferLineGoToBuffer 7"):with_silent(),
    ["n|<Leader>8"]      = map_cr("BufferLineGoToBuffer 8"):with_silent(),
};
