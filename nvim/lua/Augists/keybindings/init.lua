...
vim.api.nvim_set_keymap('n', '<C-q>', ':q<CR>', {noremap = true, silent = false})

if Augists.plugins.nvim_comment.enabled then vim.api.nvim_set_keymap('v', '<leader>/', ':CommentToggle<cr>', {noremap = true, silent = true}) end
